...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function render() {
        // Assume que localStorage contient déjà l'URL de l'image sous la clé 'img'
        ...
        if (imageUrl) {
            ...
            // Récupère le conteneur existant dans le DOM avec l'ID 'generateImage'
            const container = document.getElementById('generateImage');

            // Supprime tous les enfants existants du conteneur (si nécessaire)
            while (container.firstChild) {
                container.removeChild(container.firstChild);
            }

            // Ajoutez l'élément img à un conteneur dans le DOM avec un identifiant
            container.appendChild(imgElement);

            // Ajoutez l'identifiant à votre conteneur
    ...
    // Appel périodique de la fonction requestEnhancedSketch
